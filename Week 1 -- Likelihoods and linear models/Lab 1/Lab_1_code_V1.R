...
# Step 1 -- make and compile template file
compile(here::here("src","delta_model_v1.cpp" ))

# Step 2 -- build inputs and object
dyn.load( dynlib(here::here("src","delta_model_v1" )) )
...
compile( here::here("src","delta_model_v2.cpp" ))
dyn.load( dynlib(here::here("src","delta_model_v2") ))
